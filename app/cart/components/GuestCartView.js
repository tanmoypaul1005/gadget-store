...
/* ── Per-item product skeleton ── */
const ProductSkeleton = () => (
  <div className="animate-pulse flex items-start gap-4">
    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-xl bg-white/10 shrink-0" />
    <div className="flex-1 space-y-2 py-1">
      <div className="w-3/4 h-4 rounded bg-white/10" />
      <div className="w-1/4 h-3 rounded bg-white/10" />
      <div className="w-1/3 h-4 mt-2 rounded bg-white/10" />
    </div>
  </div>
);
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="space-y-3 md:col-span-2">
            {cartItems.map((item) => {
              ...
              const subtotal = product ? (product.price * (item.quantity || 1)).toFixed(2) : null;
            ...
            <div className="bg-[#111118] border border-white/5 rounded-2xl overflow-hidden">
              ...
              <div className="px-5 py-5 space-y-3">
                ...
                <Link href="/" className="block">
                  <CommonButton variant="secondary" fullWidth>
                    Continue Shopping
                  </CommonButton>
                </Link>

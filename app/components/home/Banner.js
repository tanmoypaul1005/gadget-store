  ...
  return (
    <div className="relative flex items-center justify-center mx-auto mt-10 rounded lg:w-3/4 banner lg:-mt-4">
      <Image
        ...
        alt=""
      />
      <div className="rounded cursor-pointer absolute z-10 pl-3 flex flex-col items-start justify-center w-full h-full text-black hover:bg-[#00000099] hover:text-white ">

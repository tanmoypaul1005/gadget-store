  ...
  return (
    <>
      <div onClick={() => {
        ...
        className={`relative py-4 cursor-pointer overflow-hidden px-2.5 border border-cBorderColor text-white duration-500 shadow-md bg-cCommonBg rounded-xl ${width}`}>

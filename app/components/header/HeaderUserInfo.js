          ...
          <div className="flex items-center h-16 gap-3 lg:gap-5">
            ...
            <div className="flex items-center gap-2 ml-auto md:hidden">
              {!session && (
                <button
                  onClick={handleGoogleAuthClick}
                  className="flex items-center justify-center transition-colors duration-200 bg-indigo-600 shadow-lg w-9 h-9 hover:bg-indigo-500 rounded-xl shadow-indigo-600/30"
          ...
          <div className="bg-[#0f0f17] border-t border-white/5 px-4 py-3 space-y-1">
            {session ? (
              <>
                ...
                <MobileNavItem href="/profile" onClick={() => setMobileMenuOpen(false)} icon={
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                ...
                <MobileNavItem href="/orders" badge={totalOrder} onClick={() => setMobileMenuOpen(false)} icon={
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                      d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                  </svg>
                ...
                <MobileNavItem href="/cart" badge={cartCount} onClick={() => setMobileMenuOpen(false)} icon={
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                      d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
...
/* ── Mobile Nav Item ── */
const MobileNavItem = ({ href, badge, icon, children, onClick }) => (

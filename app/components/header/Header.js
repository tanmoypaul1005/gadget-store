    ...
    <div className="w-full header">
        ...
        <nav className="justify-center hidden my-4 lg:flex">
          <ul className="flex items-center justify-center gap-12 font-bold  desktopNavbarUl font-sm">
            ...
            <li className="relative nav_items men_nav_item">
              ...
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-red-400 transition-all ease-in-out"></span>
              {/* <!--? hoverItems --> */}
              <ul className="absolute text-gray-600 flex-col items-start justify-start hidden gap-2 p-4 font-normal bg-white border shadow-lg hoveredItems w-52 top-10 rounded-xl">
                <li>
                  <a href="#">Shirt</a>
                </li>
                <li>
            ...
            <li className="relative nav_items women_nav_item">
              ...
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-red-400 transition-all ease-in-out"></span>
              {/* <!--? hoverItems --> */}
              <ul className="absolute flex-col text-gray-600 items-start justify-start hidden gap-2 p-4 font-normal bg-white border shadow-lg hoveredItems w-52 top-10 rounded-xl">
                <li>
            ...
            <li className="relative nav_items perfume_nav_item">
              ...
              <span className="absolute bottom-0 text-gray-600 left-0 w-0 h-0.5 bg-red-400 transition-all ease-in-out"></span>
              {/* <!--? hoverItems --> */}
              <ul className="absolute text-gray-600 flex-col items-start justify-start hidden gap-2 p-4 font-normal bg-white border shadow-lg hoveredItems w-52 top-10 rounded-xl">
                <li>
            ...
            <li className="relative nav_items">
              ...
              <span className="absolute text-gray-600 bottom-0 left-0 w-0 h-0.5 bg-red-400 transition-all ease-in-out"></span>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <div className="mobileNavbar">
          ...
          <div className="pb-3 text-gray-600 border-b mobile_navbar_item">
            <details>
              <div className="flex flex-col items-start border shadow-xl rounded-xl">
                <a className="w-full pb-2 border-b" href="#">
                  English
                </a>
                <a className="w-full pb-2 border-b" href="#">
                  Persian
        ...
        >
          ...
          <div className="flex flex-col items-start justify-start w-full h-auto gap-4 mt-2 bestsellers">

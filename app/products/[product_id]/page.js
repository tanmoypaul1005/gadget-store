        ...
        <section className=" body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <Image style={{maxHeight:"500px"}} src={productDetails?.image} className='lg:w-1/2 w-full object-contain object-center rounded border border-gray-200' width={500} height={500} alt="" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm title-font tracking-widest">{commonView(productDetails?.brand)}</h2>
                        <h1 className="text-3xl title-font font-medium mb-1">{commonView(productDetails?.name)}</h1>

...
const CommonButton = ({
  ...
  return (
    <button onClick={onClick} className={`flex px-6 py-3 text-xl font-semibold ml-auto text-white bg-red-500 border-0 rounded focus:outline-none hover:bg-red-600`}>
      {btnLabel}
    </button>
  );
};
